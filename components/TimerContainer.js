...
export const TimerContainer = ({ days, hours, minutes, seconds }) => {
  ...
  return (
    <div className="-mt-20 rounded-xl bg-red-500"> {/* Added bg-red-500 class for red background */}
      <div className="flex items-center space-x-1 justify-between mt-2 rounded-xl px-6 py-8 responsive-padding">
        ...
        <span className="text-3xl -mt-8 md:inline-block md:text-5xl font-normal text-red-700 ">
          :
        </span>
