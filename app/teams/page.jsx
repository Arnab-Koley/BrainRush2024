            ...
            <section className="text-gray-600  body-font sm:mx-0 ">
              <div className="container py-24 mx-auto flex flex-wrap items-center justify-center w-screen">
                <div className="flex flex-wrap items-center justify-center md:w-full  lg:w-1/2 mainTeamButton">
                  <div className="p-2 lg:w-full md:w-full sm:w-full hover:scale-105 shadow-md shadow-white">
                    <div className="flex border-2 rounded-lg border-white teaminnerbutton border-opacity-50 p-8 sm:flex-row flex-col">
                      ...
                      <div className="flex-grow">
                        ...
                        {team?.teamMemberConfirmation ? (
                          <p className="leading-relaxed text-base text-gray-400 mb-3">
                            Team Member
                            <span className="text-white">{team?.teamMember.name}
                            </span>{" "}
                          </p>
                        ) : (
                          <p className="leading-relaxed text-base text-gray-400 mb-3">
                            Team Member
                            <span className="text-white">Not Joined
                            </span>
                          </p>
                        )}
                        {!team?.teamMemberConfirmation &&
              ...
              <div className="container px-5 py-24 mx-auto">
                <div className=" flex flex-wrap gap-8 items-center justify-center -m-4">
                  <div className=" p-4 lg:w-1/3 md:w-full">
                    <div className=" hover:scale-105 shadow-md shadow-white flex border-2 rounded-lg border-gray-200 teaminnerbutton border-opacity-50 p-8 sm:flex-row flex-col">
                      <div className="w-16 h-16 sm:mr-8 sm:mb-0 mb-4 inline-flex items-center justify-center rounded-full bg-indigo-100 text-indigo-500 flex-shrink-0">
                        <svg
                          fill="none"
                          stroke="currentColor"
                      ...
                      <div className="flex-grow">
                        <h2
                          className="text-red text-4xl title-font font-2xl mb-3"
                  ...
                  <div className="p-4 lg:w-1/3 md:w-full">
                    <div className="hover:scale-105 shadow-md shadow-white flex border-2 rounded-lg border-gray-200 border-opacity-50 p-8 sm:flex-row flex-col">
                      <div className="w-16 h-16 sm:mr-8 sm:mb-0 mb-4 inline-flex items-center justify-center rounded-full bg-indigo-100 text-indigo-500 flex-shrink-0">
                        <svg
                          fill="none"
                          stroke="currentColor"
                      ...
                      <div className="flex-grow">
                        <h2 className="text-red text-3xl title-font font-2xl mb-3">
                          <span className="font-bold">
                            Create Team
                          </span>
                        </h2>
