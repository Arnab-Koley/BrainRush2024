            ...
            <form className="space-y-8" onSubmit={submitHandler}>
              <div>
                ...
                <input
                  type="text"
                  id="email"
                  className={`profileInput h-2 lg:h-full shadow-md bg-inputBgColor border-gray-300 text-white text-xl rounded-lg focus:ring-primary-500 focus:border-gray-50 block w-full p-2.5 ${isError1}`}
              ...
              <div>
                ...
                <input
                  ...
                  minLength={10}
                  required
                  className={`h-2 lg:h-full profileInput shadow-md bg-inputBgColor text-white text-xl rounded-lg  w-full p-2.5 ${isError2}`}
